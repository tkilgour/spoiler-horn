<template>
  <Layout>
    <p class="italic">A complete list of all Reconcillable Difference's Smoiler Smots.</p>
    <div v-for="show in filteredShows" :key="show.id" class="mt-10 px-4 py-5 border border-gray-700 rounded-lg">
      ...
      <div class="flex">
        <a class="mt-8 px-2 py-1 flex justify-center border-2 border-orange-600 bg-white text-orange-700 rounded outline-none hover:bg-orange-800 focus:bg-orange-800" :href="`https://overcast.fm/${show.node.overcastId}/${show.node.timestamps[0]}`">
